...
export default function SignUp() {
  ...
  const handleSubmit = (e) => {
    if (userType == "Admin" && secretKey != "SourabhP") {
      e.preventDefault();
      alert("Invalid Admin");
    } else {
      e.preventDefault();
  ...
  return (
    <div className="auth-wrapper" >
      <div className="auth-inner" style={{display:"flex",justifyContent:"center"}}>
        <form onSubmit={handleSubmit} className="Signupform w-25 p-4 m-4 border border-black" style={{border:"2px",borderRadius:"20px"}}>
